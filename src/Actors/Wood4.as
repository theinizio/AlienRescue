package Actors
{
	 ...
	 */
	public class Wood4 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood6.png")]
		private var Actor8Img:Class;
		...
		public function Wood4(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
