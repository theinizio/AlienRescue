package Actors
{
	 ...
	 */
	public class Wood10 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood10.png")]
		private var Actor14Img:Class;
		...
		public function Wood10(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
