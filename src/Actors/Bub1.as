package Actors
{
	 ...
	 */
	public class Bub1 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="bub1.png")]
		private var Actor17Img:Class;
		...
		public function Bub1(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
		...
		public function init():void {
			...
			trace("BUB1 fr="+dynamicBody.IsFixedRotation());
			dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce), dynamicBody.GetWorldCenter());
		}
