package Actors
{
	 ...
	 */
	public class Wood12 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood12.png")]
		private var Actor16Img:Class;
       ...
       public function playDestroySnd(e:MouseEvent=null):void {
		...
		public function Wood12(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
