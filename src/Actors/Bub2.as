package Actors
{
	 ...
	 */
	public class Bub2 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="bub2.png")]
		private var Actor18Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor17";
		...
		public function Bub2(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
		...
		public function destroy():void {
			if(dynamicBody)	world.DestroyBody(dynamicBody);
			//playDestroySnd();			
			dynamicBody = null;
		...
		public function init():void {
			...
			dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce *2.5), dynamicBody.GetWorldCenter());
			dynamicBody.SetFixedRotation(false);
		}
		
		private function enterFrameFunction(e:Event):void {
			
			//dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce * 2.5), dynamicBody.GetPosition());
