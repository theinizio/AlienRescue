package Actors
{
	 ...
	 */
	public class Tnt7 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tnt7.png")]
		private var Actor42Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor42";
		...
		public function Tnt7(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
