package Actors
{
	 ...
	 */
	public class Met7 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="met8.png")]
		private var Actor35aImg:Class;
		public var imga:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met8b.png")]
		private var Actor35bImg:Class;
		public var imgb:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met8c.png")]
		private var Actor35cImg:Class;
		...
		public function Met7(World:b2World, X:Number = 0, Y:Number = 0, Rotation:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = Rotation;
		...
		public function init():void {
			...
			imga = new Actor35aImg();
			W = imga.width;
			H = imga.height;
			
			imga.x = -W/2;
			imga.y = -H/2;
			imgb = new Actor35bImg();
			imgb.x = -W/2;
			imgb.y = -H / 2;
			imgb.visible = false;
			imgc = new Actor35cImg();
			imgc.x = -W/2;
			imgc.y = -H/2;
			imgc.visible = false;
