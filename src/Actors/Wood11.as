package Actors
{
	 ...
	 */
	public class Wood11 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood11.png")]
		private var Actor15Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor15";
		...
		public function Wood11(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
