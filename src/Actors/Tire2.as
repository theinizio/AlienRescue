package Actors
{
	 ...
	 */
	public class Tire2 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tire2.png")]
		private var Actor24Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor24";
		...
		public function Tire2(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
