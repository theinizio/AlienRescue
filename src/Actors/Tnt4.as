package Actors
{
	 ...
	 */
	public class Tnt4 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tnt4.png")]
		private var Actor40Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor40";
		...
		public function Tnt4(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
