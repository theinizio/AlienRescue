package Actors
{
	 ...
	 */
	public class Wood1 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood1.png")]
		private var Actor5Img:Class;
		...
		public function Wood1(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
