package Actors
{
	 ...
	 */
	public class Wood7 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood7.png")]
		private var Actor11Img:Class;
		...
		public function Wood7(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
