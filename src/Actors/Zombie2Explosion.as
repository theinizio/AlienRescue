package Actors
{
	 ...
	 */
	public class Zombie2Explosion extends Sprite
	{
		public static const ANIMATION_FINISHED:String = "animationFinished";
		
		
		[Embed(source='../../lib/images.swf', symbol='Zombie2Explosion.png')]
		private var Z2ExplImg:Class;
		...
		public function Zombie2Explosion() {
			
			explosion = new Z2ExplImg();
