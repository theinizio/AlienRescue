package Actors
{
	 ...
	 */
	public class Tire1 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tire1.png")]
		private var Actor23Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor23";
		...
		public function Tire1(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
