package Actors
{
	 ...
	 */
	public class Met4 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="met4.png")]
		private var Actor32aImg:Class;
		public var imga:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met4b.png")]
		private var Actor32bImg:Class;
		public var imgb:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met4c.png")]
		private var Actor32cImg:Class;
		public var imgc:Bitmap;
		
		//private var name:String= "Actor30";
		private var W:Number = 192;
		...
		public function Met4(World:b2World, X:Number = 0, Y:Number = 0, Rotation:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = Rotation;
		...
		public function init():void {
			...
			imga = new Actor32aImg();
			W = imga.width;
			H = imga.height;
			
			imga.x = -W/2;
			imga.y = -H/2;
			imgb = new Actor32bImg();
			imgb.x = -W/2;
			imgb.y = -H / 2;
			imgb.visible = false;
			imgc = new Actor32cImg();
			imgc.x = -W/2;
			imgc.y = -H/2;
			imgc.visible = false;
