package Actors
{
	 ...
	 */
	public class Met6 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="met7.png")]
		private var Actor34aImg:Class;
		public var imga:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met7b.png")]
		private var Actor34bImg:Class;
		public var imgb:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met7c.png")]
		private var Actor34cImg:Class;
		public var imgc:Bitmap;
		
		//private var name:String= "Actor34";
		...
		public function Met6(World:b2World, X:Number = 0, Y:Number = 0, Rotation:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = Rotation;
		...
		public function init():void {
			...
			imga = new Actor34aImg();
			W = imga.width;
			H = imga.height;
			
			imga.x = -W/2;
			imga.y = -H/2;
			imgb = new Actor34bImg();
			imgb.x = -W/2;
			imgb.y = -H / 2;
			imgb.visible = false;
			imgc = new Actor34cImg();
			imgc.x = -W/2;
			imgc.y = -H/2;
			imgc.visible = false;
