package Actors
{
	 ...
	 */
	public class Met5 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="met6.png")]
		private var Actor33aImg:Class;
		public var imga:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met6b.png")]
		private var Actor33bImg:Class;
		public var imgb:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met6c.png")]
		private var Actor33cImg:Class;
		public var imgc:Bitmap;
		
		//private var name:String= "Actor33";
		private var W:Number = 384;
		...
		public function Met5(World:b2World, X:Number = 0, Y:Number = 0, Rotation:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = Rotation;
		...
		public function init():void {
			...
			imga = new Actor33aImg();
			W = imga.width;
			H = imga.height;
			
			imga.x = -W/2;
			imga.y = -H/2;
			imgb = new Actor33bImg();
			imgb.x = -W/2;
			imgb.y = -H / 2;
			imgb.visible = false;
			imgc = new Actor33cImg();
			imgc.x = -W/2;
			imgc.y = -H/2;
			imgc.visible = false;
