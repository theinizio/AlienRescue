package Actors
{
	 ...
	 */
	public class Tnt2 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tnt2.png")]
		private var Actor38Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor38";
		...
		public function Tnt2(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
