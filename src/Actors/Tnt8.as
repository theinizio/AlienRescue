package Actors
{
	 ...
	 */
	public class Tnt8 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tnt8.png")]
		private var Actor43Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor43";
		...
		public function Tnt8(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
