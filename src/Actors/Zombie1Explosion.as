package Actors
{
	 ...
	 */
	public class Zombie1Explosion extends Sprite
	{
		public static const ANIMATION_FINISHED:String = "animationFinished";
		
		
		[Embed(source='../../lib/images.swf', symbol='Zombie1Explosion.png')]
		private var Z1ExplImg:Class;
		...
		public function Zombie1Explosion() {
			
			explosion = new Z1ExplImg();
