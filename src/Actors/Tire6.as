package Actors
{
	 ...
	 */
	public class Tire6 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tire6.png")]
		private var Actor28Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor28";
		...
		public function Tire6(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
