package Actors
{
	 ...
	 */
	public class Wood5 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood5.png")]
		private var Actor9Img:Class;
		...
		public function Wood5(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
