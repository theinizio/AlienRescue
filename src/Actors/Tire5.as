package Actors
{
	 ...
	 */
	public class Tire5 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tire5.png")]
		private var Actor27Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor27";
		...
		public function Tire5(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
