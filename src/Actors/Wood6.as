package Actors
{
	 ...
	 */
	public class Wood6 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood4.png")]
		private var Actor10Img:Class;
       ...
       public function playDestroySnd(e:MouseEvent=null):void {
		...
		public function Wood6(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
