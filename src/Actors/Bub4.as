package Actors
{
	 ...
	 */
	public class Bub4 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="bub4.png")]
		private var Actor20Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor20";
       ...
       public function playDestroySnd(e:MouseEvent=null):void {
		...
		public function Bub4(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
		...
		public function init():void {
			...
			dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce*8), dynamicBody.GetWorldCenter());
		}
