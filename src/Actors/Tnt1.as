package Actors
{
	 ...
	 */
	public class Tnt1 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tnt1.png")]
		private var Actor37Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor37";
		...
		public function Tnt1(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
