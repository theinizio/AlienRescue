package Actors
{
	 ...
	 */
	public class Tnt3 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tnt3.png")]
		private var Actor39Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor39";
		...
		public function Tnt3(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
		...
		public function destroy(e:Event = null):Boolean {
			if (!destroyed) {
