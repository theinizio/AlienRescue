package Actors
{
	 ...
	 */
	public class Bub6 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="bub6.png")]
		private var Actor22Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor22";
		...
		public function Bub6(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
		...
		public function init():void {
			...
			dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce*12), dynamicBody.GetWorldCenter());
		}
