package Actors
{
	 ...
	 */
	public class Wood8 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood8.png")]
		private var Actor12Img:Class;
		...
		public function Wood8(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
