package Actors
{
	 ...
	 */
	public class Met2 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="met2.png")]
		private var Actor30aImg:Class;
		public var imga:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met2b.png")]
		private var Actor30bImg:Class;
		public var imgb:Bitmap;
		[Embed (source ="../../lib/images.swf", symbol="met2c.png")]
		private var Actor30cImg:Class;
		...
		public function Met2(World:b2World, X:Number = 0, Y:Number = 0, Rotation:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = Rotation;
		...
		public function init():void {
			...
			imga = new Actor30aImg();
			W = imga.width;
			H = imga.height;
			
			imga.x = -W/2;
			imga.y = -H/2;
			imgb = new Actor30bImg();
			imgb.x = -W/2;
			imgb.y = -H / 2;
			imgb.visible = false;
			imgc = new Actor30cImg();
			imgc.x = -W/2;
			imgc.y = -H/2;
			imgc.visible = false;
