package Actors
{
	 ...
	 */
	public class Wood2 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood2.png")]
		private var Actor6Img:Class;
		...
		public function Wood2(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
