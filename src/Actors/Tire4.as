package Actors
{
	 ...
	 */
	public class Tire4 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="tire4.png")]
		private var Actor26Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor26";
		...
		public function Tire4(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
