package Actors
{
	 ...
	 */
	public class Bub5 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="bub5.png")]
		private var Actor21Img:Class;
		public var img:Bitmap;
		
		//private var name:String= "Actor21";
		...
		public function Bub5(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
		...
		public function init():void {
			...
			dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce*1), dynamicBody.GetWorldCenter());
		}
