package Actors
{
	 ...
	 */
	public class Wood9 extends Sprite
	{
		[Embed (source ="../../lib/images.swf", symbol="wood9.png")]
		private var Actor13Img:Class;
       ...
       public function playDestroySnd(e:MouseEvent=null):void {
		...
		public function Wood9(World:b2World, X:Number = 0, Y:Number = 0, rot:Number = 0) {
			world = World;
			x = X;
			y = Y;
			rotation = rot;
