...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene55 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 50;
		public var spr:Sprite;
		
		public function Scene55(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 457, 322);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 386, 184);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			
			bub2 = new Bub1(world.world, 247, 184);
			addChild(bub2);
			...
			*/
			...
			wood8 = new Wood2(world.world, 90, 150);
			...
			tnt3 = new Tnt1(world.world, 464, 323);
