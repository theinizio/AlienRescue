...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene79 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 74;
		public var spr:Sprite;
		
		public function Scene79(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 254, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met3(world.world, 484, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 193, 322);
			...
			bub2 = new Bub1(world.world, 342, 322);
			addChild(bub2);
			...
			*/
			...
			wood10 = new Wood11(world.world, 399, 184);
			...
			wood11 = new Wood2(world.world, 403, 150);
			...
			wood12 = new Wood11(world.world, 489, 236);
