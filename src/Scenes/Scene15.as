...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene15 extends MovieClip
	{
		...
		[Embed(source='../../lib/images.swf', symbol='in8.png')]
		private var IN8:Class;
		private var in8:Bitmap;
		private var in8OnScene:Boolean;
		...
		private var currentLevel:uint = 10;
		public var spr:Sprite;
		
		public function Scene15(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 482, 114);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met1(world.world, 181, 322);
			addChild(met2);
			physItems.push(met2);
			/*
		...
		//	physItems.push(tnt2);
			...
			/*
			wood7 = new Wood3(world.world, 385, 184);
			addChild(wood7);
			...
			*/
			...
			zombie1 = new Zombie1(world.world, 106, 248);
			addChild(zombie1);
		...
		private function burnIt(e:MouseEvent):void { 
			...
			zombie1.explode();
			//if(met1)met1.animStart();
			//if(met2)met2.animStart();
			//trace(world.contactListener.metToAnimate);
			if (world.contactListener.metToAnimate!=null)
