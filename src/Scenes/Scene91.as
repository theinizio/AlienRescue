...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene91 extends MovieClip
	{
		...
		private var currentLevel:uint = 86;
		public var spr:Sprite;
		
		public function Scene91(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met1(world.world, 291, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 199, 322);
			...
			bub2 = new Bub5(world.world, 318, 184);
			...
			*/
			...
			wood10 = new Wood11(world.world, 534, 271);
			...
			*/
			/*
			wood11 = new Wood11(world.world, 448, 115);
