...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene57 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 52;
		public var spr:Sprite;
		
		public function Scene57(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met5(world.world, 518, 235);
			met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 400, 304);
			met2.setRotation(1.5 * Math.PI);
			addChild(met2);
			physItems.push(met2);
			
			met3= new Met3(world.world, 146, 304);
			met3.setRotation(1.5 * Math.PI);
			addChild(met3);
			physItems.push(met3);
			/*
			bub1 = new Bub1(world.world, 351, 184);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			
			bub2 = new Bub1(world.world, 212, 184);
			addChild(bub2);
			...
			*/
			...
			tnt1 = new Tnt1(world.world, 106, 322);
			//tnt1.setRotation(1.5 * Math.PI);
			addChild(tnt1);
			
			tnt2 = new Tnt1(world.world, 440, 322);
			//tnt2.setRotation(1.5 * Math.PI);
			addChild(tnt2);
			
			wood7 = new Wood3(world.world, 214, 193);
			...
			*/
			wood8 = new Wood7(world.world, 214, 158);
			...
			*/
			zombie1 = new Zombie2(world.world, 492, 110);
			addChild(zombie1);
