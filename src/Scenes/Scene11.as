...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene11 extends MovieClip
	{
		...
		private var currentLevel:uint = 6;
		
		
		public function Scene11(World:PhysWorld):void {
			world = World;
...
Log.LevelCounterMetric("EnterLevel", "Level"+currentLevel);
			...
			zombie1 = new Zombie1(world.world, 400, 145);
			addChild(zombie1);
