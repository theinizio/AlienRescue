...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene83 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 78;
		public var spr:Sprite;
		
		public function Scene83(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 323, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met3(world.world, 28, 305);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 283, 236);
			...
			*/
			...
			wood10 = new Wood2(world.world, 317, 115);
			...
			*/
			...
			wood11 = new Wood1(world.world, 253, 115);
			...
			*/
			zombie1 = new Zombie3(world.world, 284, 76);
			addChild(zombie1);
