...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene17 extends MovieClip
	{
		...
		private var currentLevel:uint = 12;
		public var spr:Sprite;
		
		public function Scene17(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met4(world.world, 474, 322);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			*/
			...
			wood1 = new Wood9(world.world, 326, 322);
			addChild(wood1);
			wood1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood1);
			/*
			tire1 = new Tire3(world.world, 244, 287);
			addChild(tire1);
			tire1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(tire1);
			
			
			tnt2 = new Tnt3(world.world, 50, 322);
			addChild(tnt2);
			tnt2.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(tnt2);
			*/
			wood2 = new Wood11(world.world, 306, 287);
			addChild(wood2);
