...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene56 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 51;
		public var spr:Sprite;
		
		public function Scene56(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 318, 184);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met3(world.world, 277, 322);
			addChild(met2);
			physItems.push(met2);
			/*
			...
			*/
			...
			tnt1 = new Tnt5(world.world, 318, 322);
			//tnt1.setRotation(1.5 * Math.PI);
			addChild(tnt1);
			
			wood3 = new Wood9(world.world, 377, 218);
			...
			*/
			wood8 = new Wood11(world.world, 318, 114);
			...
			/*
			tnt4 = new Tnt1(world.world, 504, 323);
			addChild(tnt4);
			...
			wood9 = new Wood3(world.world, 504, 288);
			...
			*/
			zombie1 = new Zombie2(world.world, 329, 76);
			addChild(zombie1);
