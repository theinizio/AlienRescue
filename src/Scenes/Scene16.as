...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene16 extends MovieClip
	{
		...
		private var currentLevel:uint = 11;
		public var spr:Sprite;
		
		public function Scene16(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met7(world.world, 474, 322);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			*/
			...
			wood1 = new Wood11(world.world, 204, 322);
			addChild(wood1);
			...
			*/
			...
			zombie1 = new Zombie1(world.world, 192, 145);
			addChild(zombie1);
