...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene77 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 72;
		public var spr:Sprite;
		
		public function Scene77(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 317, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met2(world.world, 322, 305);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 258, 322);
			...
			bub2 = new Bub1(world.world, 377, 322);
			addChild(bub2);
			...
			*/
			zombie1 = new Zombie3(world.world, 317, 111);
			addChild(zombie1);
