...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene70	 extends MovieClip
	{
		...
		private var wood4:Wood4;
		private var wood5:Wood7;
		private var wood6:Wood7;
		private var wood7:Wood4;
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 65;
		public var spr:Sprite;
		
		public function Scene70(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met4(world.world, 487, 253);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met3(world.world, 134, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 486, 288);
			...
			bub2 = new Bub1(world.world, 173, 150);
			addChild(bub2);
			bub2.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub2);
			
			bub3 = new Bub1(world.world, 337, 184);
			addChild(bub3);
			...
			*/
			...
			wood1 = new Wood11(world.world, 379, 219);	
		...
		//	wood5.setRotation(1.5 * Math.PI);
			...
			tnt4 = new Tnt1(world.world, 342, 219);
			//tnt4.setRotation(-.25 * Math.PI);
			addChild(tnt4);
			*/
			
			wood10 = new Wood7(world.world, 113, 167);
			...
			*/
			zombie1 = new Zombie3(world.world, 143, 76);
			addChild(zombie1);
