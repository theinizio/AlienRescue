...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene21 extends MovieClip
	{
		...
		private var currentLevel:uint = 16;
		public var spr:Sprite;
		
		public function Scene21(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met1(world.world, 264, 287);
			addChild(met1);
			physItems.push(met1);
			/*
			tire1 = new Tire3(world.world, 373, 322);
			addChild(tire1);
			...
			*/
			...
			zombie1 = new Zombie1(world.world, 75, 110);
			addChild(zombie1);
