...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene75 extends MovieClip
	{
		...
		private var met2:Met4;
		//private var met3:Met3;
		
		private var bub1:Bub1;
		//private var bub2:Bub6;
		...
		private var wood2:Wood3;
		private var wood3:Wood5;
		...
		//private var wood10:Wood3;
		//private var wood11:Wood1;
		//private var wood12:Wood7;
		//private var wood13:Wood7;
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 70;
		public var spr:Sprite;
		
		public function Scene75(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 529, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met4(world.world, 191, 288);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 231, 253);
			...
			/*
			bub2 = new Bub6(world.world, 282, 305);
			addChild(bub2);
			...
			*/
			...
			wood1 = new Wood9(world.world, 271, 288);	
			...
			tnt1 = new Tnt1(world.world, 337, 322);
			...
			*/
			...
			wood10 = new Wood3(world.world, 241, 150);
			...
			wood11 = new Wood1(world.world, 324, 150);
			...
			wood14 = new Wood11(world.world, 285, 46);
			addChild(wood14);
			...
			*/
			zombie1 = new Zombie3(world.world, 142, 111);
			addChild(zombie1);
