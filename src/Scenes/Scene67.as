...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene67	 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 62;
		public var spr:Sprite;
		
		public function Scene67(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 239, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 397, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 317, 150);
		...
		//	wood5.setRotation(1.5 * Math.PI);
			...
			*/
			...
			wood10 = new Wood11(world.world, 222, 115);
			addChild(wood10);
