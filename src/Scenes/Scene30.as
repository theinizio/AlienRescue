...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene30 extends MovieClip
	{
		...
		private var currentLevel:uint = 25;
		public var spr:Sprite;
		
		public function Scene30(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			*/
			...
			addChild(tnt3);
			*/
			wood5 = new Wood11(world.world, 331, 148);
			addChild(wood5);
			wood5.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood5);
			
			met1= new Met1(world.world, 417, 321);
			addChild(met1);
			physItems.push(met1);
			
			/*	
			tnt1 = new Tnt1(world.world, 202, 184);
			addChild(tnt1);
			
			wood6 = new Wood11(world.world, 365, 253);
			addChild(wood6);
			...
			wood7 = new Wood7(world.world, 365, 305);
			addChild(wood7);
			...
			wood8 = new Wood2(world.world, 82, 148);
			addChild(wood8);
			...
			addChild(tnt2);
			*/
			zombie1 = new Zombie1(world.world, 341, 109);
			addChild(zombie1);
