...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene52 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 47;
		public var spr:Sprite;
		
		public function Scene52(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 101, 322);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			bub1 = new Bub1(world.world, 182, 253);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			
			bub2 = new Bub1(world.world, 384, 253);
			addChild(bub2);
			...
			*/
			...
			wood8 = new Wood2(world.world, 472, 149);
			...
			addChild(tnt5);
			*/
			wood9 = new Wood7(world.world, 413, 149);
			...
			*/
			...
			wood10 = new Wood1(world.world, 393, 184);
			addChild(wood10);
			...
			tnt2 = new Tnt1(world.world, 393, 253);
			...
			tnt3 = new Tnt1(world.world, 313, 253);
			//tnt3.setRotation(1.5 * Math.PI);
			addChild(tnt3);
			/*
			tnt4 = new Tnt3(world.world, 45, 322);
			addChild(tnt4);
			...
			*/
			zombie1 = new Zombie2(world.world, 476, 76);
			addChild(zombie1);
