...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene31 extends MovieClip
	{
		...
		private var currentLevel:uint = 26;
		public var spr:Sprite;
		
		public function Scene31(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 147, 321);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 499, 321);
			addChild(met2);
			physItems.push(met2);
			...
			*/
			...
			tnt3 = new Tnt3(world.world, 323, 218);
			addChild(tnt3);
			
			wood5 = new Wood7(world.world, 216, 148);
			addChild(wood5);
			wood5.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood5);
			
				
			wood6 = new Wood7(world.world, 431, 148);
			addChild(wood6);
			...
			physItems.push(bub1);
			*/
			wood7 = new Wood7(world.world, 281, 129);
			wood7.setRotation(45/180 * Math.PI);
			addChild(wood7);
			...
			addChild(tnt2);
				*/
			wood8 = new Wood7(world.world, 366, 129);
			wood8.setRotation(315/180 * Math.PI);
			addChild(wood8);
			wood8.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood8);
			/*
			wood9 = new Wood1(world.world, 63, 114);
			addChild(wood9);
			...
			*/
			zombie1 = new Zombie1(world.world, 325, 89);
			zombie1.setRotation(.25* Math.PI);
			addChild(zombie1);
