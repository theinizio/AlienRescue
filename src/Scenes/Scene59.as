...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene59 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 54;
		public var spr:Sprite;
		
		public function Scene59(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met4(world.world, 457, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met4(world.world, 179, 322);
			...
			*/
			...
			tnt2 = new Tnt1(world.world, 100, 322);
			//tnt2.setRotation(1.5 * Math.PI);
			addChild(tnt2);
			
			tnt3 = new Tnt1(world.world, 536, 322);
			addChild(tnt3);
			...
			*/
			...
			wood10 = new Wood7(world.world, 205, 218);
			addChild(wood10);
			...
			*/
			zombie1 = new Zombie2(world.world, 318, 283);
			addChild(zombie1);
