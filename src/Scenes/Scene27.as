...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene27 extends MovieClip
	{
		...
		private var currentLevel:uint = 22;
		public var spr:Sprite;
		
		public function Scene27(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 477, 321);
			addChild(met1);
			physItems.push(met1);
			...
			*/
			...
			addChild(tnt4);
			*/
			wood4 = new Wood7(world.world, 393, 218);
			
			addChild(wood4);
			wood4.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood4);
				
			tnt1 = new Tnt1(world.world, 328, 218);
			addChild(tnt1);
			
			tnt2 = new Tnt1(world.world, 210, 253);
			addChild(tnt2);
				
			tnt3 = new Tnt1(world.world, 441, 253);
			addChild(tnt3);
			
			wood5 = new Wood1(world.world, 257, 184);
			addChild(wood5);
			wood5.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood5);
			
			wood6 = new Wood3(world.world, 397, 184);
			addChild(wood6);
			...
			*/
			...
			addChild(tnt2);
			*/
			zombie1 = new Zombie1(world.world, 326, 76);
			addChild(zombie1);
