...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene20 extends MovieClip
	{
		...
		private var currentLevel:uint = 15;
		public var spr:Sprite;
		
		public function Scene20(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 484, 321);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			*/
			...
			tnt1 = new Tnt1(world.world, 183, 322);
			addChild(tnt1);
				
			tnt2 = new Tnt1(world.world, 322, 322);
			addChild(tnt2);
			
			zombie1 = new Zombie1(world.world, 243, 76);
			addChild(zombie1);
