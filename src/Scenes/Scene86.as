...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene86 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 81;
		public var spr:Sprite;
		
		public function Scene86(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 541, 322);
			...
			bub1 = new Bub3(world.world, 390, 305);
			...
			*/
			...
			addChild(tnt4);
			*/
			wood4 = new Wood4(world.world, 95, 305);
			...
			*/
			...
			wood10 = new Wood7(world.world, 255, 161);
			...
			*/
			...
			wood11 = new Wood7(world.world, 379, 161);
			...
			*/
			zombie1 = new Zombie3(world.world, 315, 71);
			addChild(zombie1);
