...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene8 extends MovieClip
	{
		...
		public function Scene8(World:PhysWorld):void {
			world = World;
...
Log.LevelCounterMetric("EnterLevel", "Level"+currentLevel);
			...
			pauseBitmap.bitmapData = new BitmapData(640, 480, true, 0x88000000);
		...
		private function loadScene(evt:MouseEvent):void {
			...
			switch(evt.target) {
				...
				case leftArrowButton: { newScene = 7; break; }
				case completeButton:
				case rightArrowButton: { newScene = 9; break; }
			}
