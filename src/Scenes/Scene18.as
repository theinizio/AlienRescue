...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene18 extends MovieClip
	{
		...
		private var currentLevel:uint = 13
		public var spr:Sprite;
		
		public function Scene18(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met1(world.world, 440, 322);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			*/
			...
			wood1 = new Wood7(world.world, 500, 322);
			addChild(wood1);
			...
			physItems.push(tnt2);
			*/
			wood2 = new Wood11(world.world, 469, 287);
			addChild(wood2);
			...
			*/
			...
			zombie1 = new Zombie1(world.world, 149, 214);
			addChild(zombie1);
