...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene94 extends MovieClip
	{
		...
		private var currentLevel:uint = 89;
		public var spr:Sprite;
		
		public function Scene94(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met1(world.world, 218, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met1(world.world, 417, 322);
			...
			bub1 = new Bub5(world.world, 283, 322);
			...
			bub2 = new Bub3(world.world, 283, 288);
			...
			*/
			...
			tnt4 = new Tnt1(world.world, 278, 322);
			//tnt4.setRotation(1.5 * Math.PI);
			addChild(tnt4);
			
			
			tnt5 = new Tnt1(world.world, 358, 322);
			...
			*/
			...
			/*
			wood10 = new Wood11(world.world, 174, 115);
			...
			*/
			/*
			wood11 = new Wood11(world.world, 391, 115);
			...
			wood14 = new Wood7(world.world, 483, 201);
			wood14.setRotation(1.5 * Math.PI);
			addChild(wood14);
