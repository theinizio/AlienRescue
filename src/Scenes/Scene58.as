...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene58 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 53;
		public var spr:Sprite;
		
		public function Scene58(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met4(world.world, 437, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 180, 322);
			...
			*/
			wood10 = new Wood1(world.world, 240, 218);
			addChild(wood10);
			wood10.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood10);
			
			tnt6 = new Tnt1(world.world, 279, 322);
			addChild(tnt6);
			
			wood11 = new Wood9(world.world, 160, 253);
			...
			*/
			zombie1 = new Zombie2(world.world, 198, 76);
			addChild(zombie1);
