...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene68	 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 63;
		public var spr:Sprite;
		
		public function Scene68(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met1(world.world, 253, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met3(world.world, 362, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 402, 184);
			...
			/*
			bub2 = new Bub2(world.world, 283, 305);
			addChild(bub2);
			bub2.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub2);
			
			bub3 = new Bub2(world.world, 124, 305);
			addChild(bub3);
			...
			*/
			...
			tnt1 = new Tnt3(world.world, 312, 305);
			tnt1.setRotation(1.5 * Math.PI);
			addChild(tnt1);
			
			wood1 = new Wood11(world.world, 233, 253);	
		...
		//	wood5.setRotation(1.5 * Math.PI);
			...
			*/
			...
			wood10 = new Wood1(world.world, 454, 322);
			addChild(wood10);
			...
			*/
			zombie1 = new Zombie3(world.world, 431, 76);
			addChild(zombie1);
