...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene46 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 41;
		public var spr:Sprite;
		
		public function Scene46(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met1(world.world, 114, 322);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 314, 218);
			addChild(met2);
			physItems.push(met2);
			/*
			...
			*/
			zombie1 = new Zombie2(world.world, 347, 76);
			addChild(zombie1);
