...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene19 extends MovieClip
	{
		...
		private var currentLevel:uint = 14;
		public var spr:Sprite;
		
		public function Scene19(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met4(world.world, 488, 322);
			addChild(met1);
			physItems.push(met1);
		...
		//	physItems.push(tnt1);
			...
			*/
			...
			zombie1 = new Zombie1(world.world, 162, 110);
			addChild(zombie1);
