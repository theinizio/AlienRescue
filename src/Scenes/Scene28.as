...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene28 extends MovieClip
	{
		...
		private var currentLevel:uint = 23;
		public var spr:Sprite;
		
		public function Scene28(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 210, 321);
			addChild(met1);
			physItems.push(met1);
			...
			*/
			...
			addChild(tnt2);
			*/
			zombie1 = new Zombie1(world.world, 325, 110);
			addChild(zombie1);
