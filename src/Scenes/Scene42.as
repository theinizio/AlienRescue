...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene42 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 37;
		public var spr:Sprite;
		
		public function Scene42(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 136, 322);
			addChild(met1);
			physItems.push(met1);
			...
			physItems.push(met2);
			*/
			bub1 = new Bub2(world.world, 452, 305);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			tnt1 = new Tnt1(world.world, 76, 322);
			addChild(tnt1);
			...
			*//*
			...
			wood8 = new Wood7(world.world, 133, 253);
			...
			*/
			zombie1 = new Zombie2(world.world, 465, 145);
			addChild(zombie1);
