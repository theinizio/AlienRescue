...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene34 extends MovieClip
	{
		...
		private var currentLevel:uint = 29;
		public var spr:Sprite;
		
		public function Scene34(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met7(world.world, 525, 321);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			*/
			...
			wood6 = new Wood11(world.world, 525, 148);
			addChild(wood6);
			...
			*/
			zombie1 = new Zombie1(world.world, 264, 248);
			addChild(zombie1);
