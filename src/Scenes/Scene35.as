...
import Playtomic.*;
	...
	public dynamic class  Scene35 extends MovieClip
	{
		...
		public function Scene35(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 323, 321);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			*/
			...
			physItems.push(bub1);
			*/
			wood7 = new Wood7(world.world, 442, 218);
			addChild(wood7);
