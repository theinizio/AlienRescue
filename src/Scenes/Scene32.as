...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene32 extends MovieClip
	{
		...
		private var currentLevel:uint = 27;
		public var spr:Sprite;
		
		public function Scene32(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 429, 321);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 214, 321);
			addChild(met2);
			physItems.push(met2);
			
			bub1 = new Bub1(world.world, 322, 282);
			addChild(bub1);
			...
			physItems.push(met2);
			*/
			wood1 = new Wood11(world.world, 322, 247);
			addChild(wood1);
			wood1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood1);
			
			wood2 = new Wood7(world.world, 280, 302);
			wood2.setRotation(45/180 * Math.PI);
			addChild(wood2);
			wood2.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood2);
			
			wood3 = new Wood7(world.world, 364, 302);
			wood3.setRotation(315/180 * Math.PI);
			addChild(wood3);
			...
			tnt2 = new Tnt1(world.world, 426, 287);
			addChild(tnt2);
			
			tire1 = new Tire3(world.world, 322, 213);
			addChild(tire1);
			...
			addChild(tnt4);
			*/
			wood4 = new Wood1(world.world, 247, 213);
			addChild(wood4);
			...
			*/
			...
			physItems.push(bub1);
			*/
			wood7 = new Wood9(world.world, 398, 178);
			addChild(wood7);
			...
			*/
			zombie1 = new Zombie1(world.world, 320, 70);
			addChild(zombie1);
