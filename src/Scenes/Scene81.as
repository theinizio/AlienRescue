...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene81 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 76;
		public var spr:Sprite;
		
		public function Scene81(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met1(world.world, 416, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met1(world.world, 216, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 375, 184);
			...
			bub2 = new Bub1(world.world, 256, 184);
			addChild(bub2);
			...
			*/
			...
			wood10 = new Wood7(world.world, 196, 115);
			...
			*/
			...
			wood11 = new Wood7(world.world, 434, 115);
			...
			*/
			zombie1 = new Zombie3(world.world, 316, 76);
			addChild(zombie1);
