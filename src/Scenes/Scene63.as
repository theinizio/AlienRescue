...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene63	 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 58;
		public var spr:Sprite;
		
		public function Scene63(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 452, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 166, 322);
			...
			*/
			...
			wood1 = new Wood9(world.world, 312, 287);	
			...
			*/
			zombie1 = new Zombie2(world.world, 312, 76);
			addChild(zombie1);
