...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene92 extends MovieClip
	{
		...
		private var currentLevel:uint = 87;
		public var spr:Sprite;
		
		public function Scene92(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 317, 150);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub5(world.world, 318, 322);
			...
			bub2 = new Bub3(world.world, 318, 288);
			...
			*/
			...
			wood4 = new Wood7(world.world, 219, 236);
			...
			*/
			...
			wood10 = new Wood11(world.world, 229, 115);
			...
			*/
			zombie1 = new Zombie3(world.world, 413, 76);
			addChild(zombie1);
