...
import Playtomic.*;
	...
	public dynamic class  Scene5 extends MovieClip
	{
		...
		private var text:World3Text;
		
		public function Scene5(World:b2World, max:uint):void {
			world = World;
		...
		public function setVars(max:uint, fx:Boolean):void {
			maxLevel = max;
			if (!fx) {soundsAllowed = false;}else soundsAllowed = true;
		}
		...
		private function init(e:Event=null):void{
			...
			for (var i:int = 89; i >= 60; i--) {
				...
				boxes[i - 60] = tmpBox;
					...
					zombie = new Zombie3(world, 335, 00);
					addChild(zombie);		
					if(maxLevel<90)
				blinking = maxLevel - 60;
