...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene47 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 42;
		public var spr:Sprite;
		
		public function Scene47(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 130, 322);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 511, 321);
			addChild(met2);
			physItems.push(met2);
			/*
			...
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 312, 252);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			/*
			bub2 = new Bub1(world.world, 184, 253);
			addChild(bub2);
			...
			*/
			zombie1 = new Zombie2(world.world, 415, 75);
			addChild(zombie1);
