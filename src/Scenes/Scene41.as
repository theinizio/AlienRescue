...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene41 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 36;
		public var spr:Sprite;
		
		public function Scene41(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			bub1 = new Bub1(world.world, 251, 150);
			addChild(bub1);
			...
			*//*
			...
			addChild(tnt2);
				*/
			wood8 = new Wood7(world.world, 173, 253);
			...
			*/
			zombie1 = new Zombie2(world.world, 386, 144);
			addChild(zombie1);
