...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene48 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 43;
		public var spr:Sprite;
		
		public function Scene48(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met4(world.world, 313, 253);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 412, 114);
			addChild(met2);
			physItems.push(met2);
			
			met3= new Met3(world.world, 212, 114);
			addChild(met3);
			physItems.push(met3);
			
			bub1 = new Bub1(world.world, 244, 184);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			
			bub2 = new Bub1(world.world, 381, 184);
			addChild(bub2);
			...
			*/
			zombie1 = new Zombie2(world.world, 300, 76);
			addChild(zombie1);
