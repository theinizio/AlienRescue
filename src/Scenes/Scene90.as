...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene90 extends MovieClip
	{
		...
		private var currentLevel:uint = 85;
		public var spr:Sprite;
		
		public function Scene90(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 317, 253);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 257, 322);
			...
			*/
			...
			tnt1 = new Tnt1(world.world, 377, 322);
			...
			*/
			...
			wood4 = new Wood7(world.world, 202, 219);
			...
			*/
			...
			wood10 = new Wood7(world.world, 423, 167);
			...
			*/
			...
			wood14 = new Wood7(world.world, 518, 201);
