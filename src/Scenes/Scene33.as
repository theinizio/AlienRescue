...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene33 extends MovieClip
	{
		...
		private var currentLevel:uint = 28;
		public var spr:Sprite;
		
		public function Scene33(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 500, 321);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			physItems.push(met2);
			*/
			bub1 = new Bub3(world.world, 252, 218);
			addChild(bub1);
			bub1.dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce*-.6), bub1.dynamicBody.GetWorldCenter());
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			bub2 = new Bub3(world.world, 391, 252);
			addChild(bub2);
			bub2.dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce*-.6), bub2.dynamicBody.GetWorldCenter());
			bub2.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub2);
			
			bub3 = new Bub3(world.world, 113, 183);
			addChild(bub3);
			bub3.dynamicBody.ApplyForce(new b2Vec2(0, Parameters.bubForce*0.5), bub3.dynamicBody.GetWorldCenter());
			...
			*/
			...
			addChild(tnt4);
			*/
			wood4 = new Wood9(world.world, 212, 287);
			wood4.setRotation(0.5 * Math.PI);
			addChild(wood4);
			...
			*/
			...
			physItems.push(bub1);
			*/
			wood7 = new Wood7(world.world, 352, 304);
			wood7.setRotation(0.5 * Math.PI);
			addChild(wood7);
			...
			*/
			zombie1 = new Zombie1(world.world, 119, 110);
			addChild(zombie1);
