...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene76 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 71;
		public var spr:Sprite;
		
		public function Scene76(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met2= new Met2(world.world, 357, 305);
			//met2.setRotation(1.5 * Math.PI);
			addChild(met2);
			physItems.push(met2);
			
			met1 = new Met3(world.world, 306, 231);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 361, 253);
			...
			*/
			zombie1 = new Zombie3(world.world, 360, 214);
			addChild(zombie1);
