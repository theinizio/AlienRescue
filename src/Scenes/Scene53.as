...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene53 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 48;
		public var spr:Sprite;
		
		public function Scene53(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 349, 322);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			physItems.push(met3);
			*/
			bub1 = new Bub1(world.world, 290, 322);
			addChild(bub1);
			...
			*/
			...
			tnt3 = new Tnt1(world.world, 171, 149);
			//tnt3.setRotation(1.5 * Math.PI);
			addChild(tnt3);
			
			tnt4 = new Tnt1(world.world, 329, 149);
			addChild(tnt4);
			...
			*/
			zombie1 = new Zombie2(world.world, 219, 76);
			addChild(zombie1);
