...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene61 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 56;
		public var spr:Sprite;
		
		public function Scene61(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 392, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 431, 287);
			addChild(bub1);
			...
			*/
			...
			wood1 = new Wood7(world.world, 273, 218);	
			...
			/*
			tire3 = new Tire3(world.world, 145, 322);
			addChild(tire3);
			...
			*/
			...
			wood10 = new Wood7(world.world, 323, 148);
			addChild(wood10);
			...
			*/
			zombie1 = new Zombie2(world.world, 214, 76);
			addChild(zombie1);
