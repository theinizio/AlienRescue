...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene78 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 73;
		public var spr:Sprite;
		
		public function Scene78(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 120, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 519, 322);
			...
			bub1 = new Bub1(world.world, 223, 322);
			...
			*/
			...
			wood10 = new Wood11(world.world, 419, 184);
			...
			*/
			...
			wood11 = new Wood2(world.world, 438, 150);
			...
			*/
			...
			wood12 = new Wood11(world.world, 533, 236);
			wood12.setRotation(1.5 * Math.PI);
			addChild(wood12);
			wood12.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood12);
			
			tnt5 = new Tnt1(world.world, 533, 150);
			addChild(tnt5);
			
			wood13 = new Wood7(world.world, 486, 115);
			...
			*/
			...
			tire1 = new Tire1(world.world, 486, 80);
			...
			*/
			zombie1 = new Zombie3(world.world, 151, 76);
			addChild(zombie1);
