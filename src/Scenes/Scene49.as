...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene49 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 44;
		public var spr:Sprite;
		
		public function Scene49(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 313, 253);
			addChild(met1);
			physItems.push(met1);
			/*
			...
			bub1 = new Bub1(world.world, 214, 184);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			
			bub2 = new Bub1(world.world, 351, 184);
			addChild(bub2);
			...
			*/
			...
			wood10 = new Wood2(world.world, 353, 149);
