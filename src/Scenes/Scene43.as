...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene43 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 38;
		public var spr:Sprite;
		
		public function Scene43(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 213, 322);
			addChild(met1);
			physItems.push(met1);
			...
			physItems.push(met2);
			*/
			bub1 = new Bub5(world.world, 313, 184);
			addChild(bub1);
			...
			*/
			zombie1 = new Zombie2(world.world, 343, 76);
			addChild(zombie1);
