...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene62	 extends MovieClip
	{
		...
		private var tnt1:Tnt3;
		private var tnt2:Tnt3;
		...
		private var wood6:Wood2;
		private var wood7:Wood1;
		private var wood8:Wood2;
		private var wood9:Wood11;
		private var wood10:Wood11;
		//private var wood11:Wood9;
		//private var wood12:Wood7;
		//private var wood13:Wood3;
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 57;
		public var spr:Sprite;
		
		public function Scene62(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 432, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met3(world.world, 421, 303);
			met2.setRotation(.5 * Math.PI);
			addChild(met2);
			physItems.push(met2);
			/*
			met3= new Met3(world.world, 116, 304);
			met3.setRotation(1.5 * Math.PI);
			addChild(met3);
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 313, 184);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			/*
			
			bub2 = new Bub1(world.world, 342, 253);
			addChild(bub2);
			bub2.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub2);
			
			bub3 = new Bub1(world.world, 223, 253);
			addChild(bub3);
			...
			7physItems.push(bub4);
			*/
			
			wood1 = new Wood4(world.world, 313, 305);	
			//wood1.setRotation(-.5 * Math.PI);
			addChild(wood1);
			...
			*/
			...
			wood10 = new Wood11(world.world, 392, 149);
			addChild(wood10);
			wood10.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood10);
			
			tnt3 = new Tnt1(world.world, 173, 114);
			addChild(tnt3);
			
			tnt4 = new Tnt1(world.world, 451, 114);
			//tnt4.setRotation(-.25 * Math.PI);
			addChild(tnt4);
			/*
			tnt5 = new Tnt1(world.world, 153, 322);
			addChild(tnt5);
			...
			*/
			zombie1 = new Zombie2(world.world, 312, 110);
			addChild(zombie1);
