...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene12 extends MovieClip
	{
		...
		[Embed(source='../../lib/images.swf', symbol='in7.png')]
		private var IN7:Class;
		private var in7:Bitmap;
		private var in7OnScene:Boolean;
		...
		private var currentLevel:uint = 7;
		
		
		public function Scene12(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			*/
			...
			zombie1 = new Zombie1(world.world, 334, 145);
			addChild(zombie1);
		...
		private function loadScene(evt:MouseEvent):void {
			...
			switch(evt.target) {
				...
				case leftArrowButton: { newScene = 11; break; }
				case completeButton:
				case rightArrowButton: { newScene = 13; break; }
			}
