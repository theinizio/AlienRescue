...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene87 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 82;
		public var spr:Sprite;
		
		public function Scene87(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 439, 322);
			...
			*/
			...
			tire1 = new Tire1(world.world, 317, 322);
			...
			*/
			...
			tnt1 = new Tnt3(world.world, 318, 253);
			//tnt1.setRotation(.5 * Math.PI);
			addChild(tnt1);
			
			wood4 = new Wood7(world.world, 256, 219);
			...
			*/
			...
			wood10 = new Wood11(world.world, 318, 115);
			...
			*/
			/*
			wood11 = new Wood7(world.world, 344, 161);
			...
			wood12 = new Wood11(world.world, 282, 110);
			...
			*/
			zombie1 = new Zombie3(world.world, 290, 76);
			addChild(zombie1);
