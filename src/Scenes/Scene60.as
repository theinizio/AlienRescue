...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene60 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 55;
		public var spr:Sprite;
		
		public function Scene60(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 148, 303);
			met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 486, 303);
			...
			bub1 = new Bub3(world.world, 282, 114);
			addChild(bub1);
			...
			*/
			wood10 = new Wood7(world.world, 358, 148);
			addChild(wood10);
			...
			*/
			zombie1 = new Zombie2(world.world, 318, 109);
			addChild(zombie1);
