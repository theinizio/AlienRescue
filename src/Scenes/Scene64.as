...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene64	 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 59;
		public var spr:Sprite;
		
		public function Scene64(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 520, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met3(world.world, 144, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 372, 270);
			...
			/*
			bub2 = new Bub1(world.world, 223, 253);
			addChild(bub2);
			bub2.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub2);
			
			bub3 = new Bub1(world.world, 342, 253);
			addChild(bub3);
			...
			*/
			...
			tnt1 = new Tnt1(world.world, 372, 322);
			//tnt1.setRotation(1.5 * Math.PI);
			addChild(tnt1);
			 
			wood1 = new Wood12(world.world, 233, 201);	
			...
			*/
			...
			wood8 = new Wood1(world.world, 362, 322);
			...
			*/
			zombie1 = new Zombie2(world.world, 301, 76);
			addChild(zombie1);
