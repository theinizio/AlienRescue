...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene37 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 32;
		public var spr:Sprite;
		
		public function Scene37(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1= new Met3(world.world, 283, 322);
			addChild(met1);
			physItems.push(met1);
			/*
			met2= new Met3(world.world, 365, 183);
			addChild(met2);
			physItems.push(met2);
			*/
			bub1 = new Bub1(world.world, 353, 149);
			addChild(bub1);
			bub1.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub1);
			
			bub2 = new Bub1(world.world, 423, 287);
			addChild(bub2);
			bub2.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub2);
			
			bub3 = new Bub1(world.world, 295, 149);
			addChild(bub3);
			bub3.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(bub3);
			
			bub4 = new Bub1(world.world, 264, 287);
			addChild(bub4);
			...
			*/
			...
			addChild(tnt3);
			*/
			wood6 = new Wood9(world.world, 324, 114);
			
			addChild(wood6);
			wood6.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood6);
				/*
			wood6 = new Wood7(world.world, 417, 269);
			wood6.setRotation(0.5 * Math.PI);
			addChild(wood6);
			wood6.addEventListener(MouseEvent.CLICK, removeElement);
			physItems.push(wood6);
			...
			wood7 = new Wood7(world.world, 237, 139);
			...
			*/
			zombie1 = new Zombie2(world.world, 322, 76);
			addChild(zombie1);
