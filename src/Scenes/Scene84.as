...
import Playtomic.*;
	 ...
	 */
	public dynamic class  Scene84 extends MovieClip
	{
	...
	//	private var wood16:Wood11;
		...
		private var currentLevel:uint = 79;
		public var spr:Sprite;
		
		public function Scene84(World:PhysWorld):void {
			world = World;
		...
		private function init(e:Event=null):void {
			...
			met1 = new Met3(world.world, 132, 322);
			//met1.setRotation(1.5 * Math.PI);
			addChild(met1);
			physItems.push(met1);
			
			met2= new Met3(world.world, 502, 322);
			...
			physItems.push(met3);
			*/
			bub1 = new Bub3(world.world, 425, 305);
			...
			bub2 = new Bub3(world.world, 210, 305);
			...
			*/
			...
			addChild(tnt4);
			*/
			wood4 = new Wood9(world.world, 219, 219);
			...
			*/
			...
			/*
			wood10 = new Wood2(world.world, 282, 115);
			...
			*/
			/*
			wood11 = new Wood1(world.world, 218, 115);
			...
			*/
			zombie1 = new Zombie3(world.world, 337, 76);
			addChild(zombie1);
